...
Preloader.prototype = {
  preload: function() {
    ...
    this.add.image(this.world.centerX-128, this.world.centerY, 'preloaderBarBack')
    var bar = this.add.image(this.world.centerX-128, this.world.centerY, 'preloaderBarFront');
